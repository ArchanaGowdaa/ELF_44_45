...
public class Script1 
{
	@Parameters("bname")
	@Test
	public void login(@Optional("bname") String browserName)//default browser is chrome 
	{
		WebDriver driver=null;//upcassting//creating global variable u can launch any browser
